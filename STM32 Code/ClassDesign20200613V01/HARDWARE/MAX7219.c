...
void Temperature_DisplayUpdata(u16 Temp)
{
	...
	wei[2] = Temp/10%10;
	wei[3] = Temp%10;
	Write7219(1,number[wei[0]]);
	Write7219(2,number[wei[1]] | 0x80);//第二位要显示小数点
	Write7219(3,number[wei[2]]);
	Write7219(4,number[wei[3]]);
}
